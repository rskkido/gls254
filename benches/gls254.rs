...
#[cfg(feature = "gls254bench")]
fn bench_raw_ecdh_AD_1dt_3() -> (f64, u8) {
    let z = core_cycles();
    let mut seed = [0u8; 32];
    seed[ 0.. 8].copy_from_slice(&z.to_le_bytes());
    seed[ 8..16].copy_from_slice(&z.to_le_bytes());
    ...
    pp = Point::for_benchmarks_only_AD_1dt_3(&pp, &sk).unwrap();
    let mut tt = [0; 100];
    for i in 0..tt.len() {
        let begin = core_cycles();
        for _ in 0..100 {
...
#[cfg(feature = "gls254bench")]
fn bench_raw_ecdh_AD_1dt_4() -> (f64, u8) {
    let z = core_cycles();
    let mut seed = [0u8; 32];
    seed[ 0.. 8].copy_from_slice(&z.to_le_bytes());
    seed[ 8..16].copy_from_slice(&z.to_le_bytes());
    ...
    pp = Point::for_benchmarks_only_AD_1dt_4(&pp, &sk).unwrap();
    let mut tt = [0; 100];
    for i in 0..tt.len() {
        let begin = core_cycles();
        for _ in 0..100 {
...
#[cfg(feature = "gls254bench")]
fn bench_raw_ecdh_AD_1dt_5() -> (f64, u8) {
    let z = core_cycles();
    let mut seed = [0u8; 32];
    seed[ 0.. 8].copy_from_slice(&z.to_le_bytes());
    seed[ 8..16].copy_from_slice(&z.to_le_bytes());
    ...
    pp = Point::for_benchmarks_only_AD_1dt_5(&pp, &sk).unwrap();
    let mut tt = [0; 100];
    for i in 0..tt.len() {
        let begin = core_cycles();
        for _ in 0..100 {
...
#[cfg(feature = "gls254bench")]
fn bench_raw_ecdh_AD_2dt_2() -> (f64, u8) {
    let z = core_cycles();
    let mut seed = [0u8; 32];
    seed[ 0.. 8].copy_from_slice(&z.to_le_bytes());
    seed[ 8..16].copy_from_slice(&z.to_le_bytes());
    ...
    pp = Point::for_benchmarks_only_AD_2dt_2(&pp, &sk).unwrap();
    let mut tt = [0; 100];
    for i in 0..tt.len() {
        let begin = core_cycles();
        for _ in 0..100 {
...
#[cfg(feature = "gls254bench")]
fn bench_raw_ecdh_AD_2dt_3() -> (f64, u8) {
    let z = core_cycles();
    let mut seed = [0u8; 32];
    seed[ 0.. 8].copy_from_slice(&z.to_le_bytes());
    seed[ 8..16].copy_from_slice(&z.to_le_bytes());
    ...
    pp = Point::for_benchmarks_only_AD_2dt_3(&pp, &sk).unwrap();
    let mut tt = [0; 100];
    for i in 0..tt.len() {
        let begin = core_cycles();
        for _ in 0..100 {
...
fn main() {
    ...
    #[cfg(feature = "gls254bench")]
    {
        ...
        bx ^= x;
        println!("GLS254 raw_ECDH AD-1DT-4:         {:13.2}", v);
        let (v, x) = bench_raw_ecdh_AD_1dt_5();
        bx ^= x;
        println!("GLS254 raw_ECDH AD-1DT-5:         {:13.2}", v);
        let (v, x) = bench_raw_ecdh_AD_2dt_2();
        bx ^= x;
        println!("GLS254 raw_ECDH AD-2DT-2:         {:13.2}", v);
